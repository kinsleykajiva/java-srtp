...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        srtp_h.C_INT.withName("tm_sec"),
        srtp_h.C_INT.withName("tm_min"),
        srtp_h.C_INT.withName("tm_hour"),
        srtp_h.C_INT.withName("tm_mday"),
        srtp_h.C_INT.withName("tm_mon"),
        srtp_h.C_INT.withName("tm_year"),
        srtp_h.C_INT.withName("tm_wday"),
        srtp_h.C_INT.withName("tm_yday"),
        srtp_h.C_INT.withName("tm_isdst")
    ).withName("tm");
