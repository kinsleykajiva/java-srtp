...
public class _Mbstatet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        srtp_h.C_LONG.withName("_Wchar"),
        srtp_h.C_SHORT.withName("_Byte"),
        srtp_h.C_SHORT.withName("_State")
    ).withName("_Mbstatet");
    ...
    private static final ValueLayout _Wchar$LAYOUT = (ValueLayout)$LAYOUT.select(groupElement("_Wchar"));
     ...
     * }
     */
    public static final ValueLayout _Wchar$layout() { return _Wchar$LAYOUT; }
     ...
     * }
     */
    public static long _Wchar(MemorySegment struct) {
        if (_Wchar$LAYOUT instanceof OfInt oi) return struct.get(oi, _Wchar$OFFSET);
        if (_Wchar$LAYOUT instanceof OfLong ol) return struct.get(ol, _Wchar$OFFSET);
        throw new UnsupportedOperationException("Unsupported layout type: " + _Wchar$LAYOUT);
    }
     ...
     * }
     */
    public static void _Wchar(MemorySegment struct, long fieldValue) {
        if (_Wchar$LAYOUT instanceof OfInt oi) {
            struct.set(oi, _Wchar$OFFSET, (int) fieldValue);
        } else if (_Wchar$LAYOUT instanceof OfLong ol) {
            struct.set(ol, _Wchar$OFFSET, fieldValue);
        }
    }
