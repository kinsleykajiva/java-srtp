...
public class _heapinfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        srtp_h.C_POINTER.withName("_pentry"),
        srtp_h.C_LONG_LONG.withName("_size"),
        srtp_h.C_INT.withName("_useflag"),
    ...
    private static final long _pentry$OFFSET = $LAYOUT.byteOffset(groupElement("_pentry"));
    ...
    private static final long _useflag$OFFSET = $LAYOUT.byteOffset(groupElement("_useflag"));
